...
public interface WherePath<T> {
	...
	Where ilikeAll(T obj);

	Where notIlikeAll(T obj);
	...
	Where likeAllIfExist(T obj);

	Where notLikeAllIfExist(T obj);
	...
	Where ilikeAllIfExist(T obj);

	Where notILikeAllIfExist(T obj);
